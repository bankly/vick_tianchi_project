...
public class TairOperatorImpl {
    ...
    public static void main(String [] args) throws Exception {
        ...
        System.out.println(RaceConfig.prex_tmall+RaceConfig.teamcode+ minuteTime);
        //假设这一分钟的交易额是100;
        Double money = 100.0;
        //写入tair
        tairOperator.write(RaceConfig.prex_tmall + minuteTime, money);
        tairOperator.write(RaceConfig.prex_taobao + minuteTime, money);
        tairOperator.write(RaceConfig.prex_ratio + minuteTime, money);
